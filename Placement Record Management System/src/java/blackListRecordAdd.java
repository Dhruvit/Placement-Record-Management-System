 ...
 * @author DHRUVIT
 */
public class blackListRecordAdd extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        RequestDispatcher view = request.getRequestDispatcher("add_blackList_student.jsp");
        ...
        try{
             ...
             try{
                ...
                stmt = (Statement)con.createStatement();
                        ...
                        query = "update studentdetails set Blacklist = 1 WHERE StudentId = ?";
             ...
             {
                 System.out.println("error in blacklistrecordadd");
             }
