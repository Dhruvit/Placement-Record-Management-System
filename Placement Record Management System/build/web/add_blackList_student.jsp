...
<title>Add Blacklist Student | Placement Record Management System</title>
<style type="text/css">
<!--
.style1 {
	font-size: 24px;
...
<body>
    ...
    <tr>
      <td  height="43" colspan="3"><div align="center"><span class="style1">Add BlackList Student </span></div></td>
      </tr>
    
    <tr>
     <td width="388">&nbsp;</td>
      <td width="289">
		<form method="post" action="blackListRecordAdd">
			<table width="292" height="92" align="center">
				...
				<tr >
					<td colspan="2"><a href="blacklist_record_calculate_new"  title="See all Blacklist Student" name="blacklistrecord" />See all Blacklist Student </td>
				</tr>
		  </table>
		</form>		</td>
